...
public record StaticReverbEffect(boolean enabled, float density, float diffusion, float gain, float gainHF,
	...
	public static final MapCodec<StaticReverbEffect> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(Codec.BOOL.optionalFieldOf("enabled", true).stable().forGetter(StaticReverbEffect::enabled),
	...
	@Override
	public ReverbEffectType<StaticReverbEffect> type() {
		return ReverbEffectType.STATIC;
	}
